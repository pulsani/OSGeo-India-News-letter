...
OSGeo-India Newsletter \\
\Mundus\ \href{http://www.osgeo-India.com}{osgeo-india.com} \quad
...
\NewsletterName{OSGeo-India Newsletter} % Newsletter title
...
\includegraphics[width=0.42\textwidth]{globe.jpg}
\\
\end{wrapfigure}
...
\par\large\textit{OSGeo logo\ldots}
\vspace{10pt}
\end{center}
...
\begin{center}
\includegraphics[width=0.8\linewidth]{globe.jpg} % Example of an in-line image
\end{center}
